...
public class BuiltinCommands {
	...
	public static Instruction dup() {
		return Instruction.command(DUP);
	}

	public static Instruction dup2Int() {
		return Instruction.command(DUP2);
	}

	@NotNull
	public static Instruction dropInt() {
		return Instruction.command(DROP);
	}

	@NotNull
	public static Instruction swapInt() {
		return Instruction.command(SWAP);
	}

	@NotNull
	public static Instruction overInt() {
		return Instruction.command(OVER);
	}

	@NotNull
	public static Instruction add() {
		return Instruction.command(ADD);
	}

	@NotNull
	public static Instruction sub() {
		return Instruction.command(SUB);
	}

	@NotNull
	public static Instruction isLT() {
		return Instruction.command(IS_LT);
	}

	@NotNull
	public static Instruction isLE() {
		return Instruction.command(IS_LE);
	}

	@NotNull
	public static Instruction isEQ() {
		return Instruction.command(IS_EQ);
	}

	@NotNull
	public static Instruction isNE() {
		return Instruction.command(IS_NE);
	}

	@NotNull
	public static Instruction isGE() {
		return Instruction.command(IS_GE);
	}

	@NotNull
	public static Instruction isGT() {
		return Instruction.command(IS_GT);
	}

	@NotNull
	public static Instruction print() {
		return Instruction.command(PRINT);
	}
